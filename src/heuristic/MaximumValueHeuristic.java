...
/**
 * This heuristic sorts domains by decreasing order. So the next value will be the maximum value.
 * @author Piero Dalle Pezze
 * @version 1.1
 * @param <T> the type of objects that this object may be compared to
 */
public class MaximumValueHeuristic<T extends Comparable<T>> extends NextValueHeuristic<T> {

	/**
	 * It constructs an empty map.
	 */
	public MaximumValueHeuristic() { 
		super();
	}
	
	/**
	 * It initializes a map with the same cardinality of the list of variables. Then it initializes
	 * the structure sorting domains by decreasing order.
	 * @param variables A list of variables.
	 */
	public MaximumValueHeuristic(LinkedList<Variable<T>> variables) {
		super(variables);
		if(variables != null)
	...
	/**
	 * It initializes the map sorting domains by decreasing order.
	 * @param variables A list of variables.
	 */
	...
	public String toString() {
		return "Maximum Value Heuristic";
	}
