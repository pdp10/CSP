...
/**
 * This class represents the disequality hard constraint between Variables.
 * 
 * @author Piero Dalle Pezze
 * @version 1.1
 * @param <T> the type of objects that this object may be compared to
 */
public class DisequalityConstraint<T extends Comparable<T>> extends HardConstraint<T> {
	
    // CONSTRUCTORS
    /**
     * It initializes a disequality binary hard constraint.
     * @param var1 The first variable of the binary hard constraint.
     * @param var2 The second variable of the binary hard constraint.
     */   
    public DisequalityConstraint(Variable<T> var1, Variable<T> var2) {
    	super(var1, var2);
    }
    
    /**
     * It returns true if the values value1 and value2, respectively for the first
     * variable and the second variable, holds the disequality constraint satisfied.
